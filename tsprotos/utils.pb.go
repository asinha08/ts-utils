...
func (x *PBError) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PBError) ProtoMessage() {}

func (x *PBError) ProtoReflect() protoreflect.Message {
	mi := &file_utils_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use PBError.ProtoReflect.Descriptor instead.
func (*PBError) Descriptor() ([]byte, []int) {
	return file_utils_proto_rawDescGZIP(), []int{0}
}

func (x *PBError) GetCode() string {
	if x != nil {
		return x.Code
	}
	return ""
...
func (x *PBError) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
const file_utils_proto_rawDesc = "" +
	...
	"\amessage\x18\x02 \x01(\tR\amessageB'Z%github.com/asinha08/ts-utils/tsprotosb\x06proto3"
